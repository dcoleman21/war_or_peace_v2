...
class TurnTest < Minitest::Test
  ...
  def test_award_spoils_war_turn_type
    ...
    assert_equal 1, @war_turn.player1.deck.cards.count
    assert_equal 7, @war_turn.player2.deck.cards.count#saying actual 2
  end
  ...
  def test_who_is_the_winner_of_the_mad_turn_type
    ...
    assert_equal :mad, @mad_turn.type
    return @mad_deck1.cards[0..2] && @mad_deck2.cards[0..2]
  ...
  def test_award_spoils_returns_nothing_if_mad_turn_type
    # practice converting this one yourself!
    card1 = Card.new(:heart, 'Jack', 11)
    card2 = Card.new(:heart, '10', 10)
    card3 = Card.new(:heart, '9', 9)
    card4 = Card.new(:diamond, 'Jack', 11)
  ...
  def setup_mad_turn
    ...
    card7 = Card.new(:heart, '3', 3)
    card8 = Card.new(:diamond, '2', 2)
    @mad_deck1 = Deck.new([card1, card2, card5, card8])
    @mad_deck2 = Deck.new([card4, card3, card6, card7])
    player1 = Player.new("Megan", @mad_deck1)
    player2 = Player.new("Aurora", @mad_deck2)
    @mad_turn = Turn.new(player1, player2)
  end
end
